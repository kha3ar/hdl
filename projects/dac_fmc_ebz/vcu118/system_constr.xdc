...
set_property  -quiet -dict {PACKAGE_PIN  AT43} [get_ports tx_data_n[7]]                                  ; ## C03  FMCP_HSPC_DP0_C2M_N       MGTYTXN0_121
set_property  -quiet -dict {PACKAGE_PIN  AT42} [get_ports tx_data_p[7]]                                  ; ## C02  FMCP_HSPC_DP0_C2M_P       MGTYTXP0_121
set_property  -quiet -dict {PACKAGE_PIN  AP43} [get_ports tx_data_n[6]]                                  ; ## A23  FMCP_HSPC_DP1_C2M_N       MGTYTXN1_121
set_property  -quiet -dict {PACKAGE_PIN  AP42} [get_ports tx_data_p[6]]                                  ; ## A22  FMCP_HSPC_DP1_C2M_P       MGTYTXP1_121
set_property  -quiet -dict {PACKAGE_PIN  AM43} [get_ports tx_data_n[5]]                                  ; ## A27  FMCP_HSPC_DP2_C2M_N       MGTYTXN2_121
set_property  -quiet -dict {PACKAGE_PIN  AM42} [get_ports tx_data_p[5]]                                  ; ## A26  FMCP_HSPC_DP2_C2M_P       MGTYTXP2_121
set_property  -quiet -dict {PACKAGE_PIN  AL41} [get_ports tx_data_n[4]]                                  ; ## A31  FMCP_HSPC_DP3_C2M_N       MGTYTXN3_121
set_property  -quiet -dict {PACKAGE_PIN  AL40} [get_ports tx_data_p[4]]                                  ; ## A30  FMCP_HSPC_DP3_C2M_P       MGTYTXP3_121
set_property  -quiet -dict {PACKAGE_PIN  T42} [get_ports tx_data_p[2]]                                   ; ## A34  FMCP_HSPC_DP4_C2M_P       MGTYTXP0_126
set_property  -quiet -dict {PACKAGE_PIN  T43} [get_ports tx_data_n[2]]                                   ; ## A35  FMCP_HSPC_DP4_C2M_N       MGTYTXN0_126
set_property  -quiet -dict {PACKAGE_PIN  P42} [get_ports tx_data_p[0]]                                   ; ## A38  FMCP_HSPC_DP5_C2M_P       MGTYTXP1_126
set_property  -quiet -dict {PACKAGE_PIN  P43} [get_ports tx_data_n[0]]                                   ; ## A39  FMCP_HSPC_DP5_C2M_N       MGTYTXN1_126
set_property  -quiet -dict {PACKAGE_PIN  M42} [get_ports tx_data_p[1]]                                   ; ## B36  FMCP_HSPC_DP6_C2M_P       MGTYTXP2_126
set_property  -quiet -dict {PACKAGE_PIN  M43} [get_ports tx_data_n[1]]                                   ; ## B37  FMCP_HSPC_DP6_C2M_N       MGTYTXN2_126
set_property  -quiet -dict {PACKAGE_PIN  K42} [get_ports tx_data_p[3]]                                   ; ## B32  FMCP_HSPC_DP7_C2M_P       MGTYTXP3_126
set_property  -quiet -dict {PACKAGE_PIN  K43} [get_ports tx_data_n[3]]                                   ; ## B33  FMCP_HSPC_DP7_C2M_N       MGTYTXN3_126
...
# create_clock -name tx_div_clk   -period  2.597 [get_pins i_system_wrapper/system_i/util_dac_jesd204_xcvr/inst/i_xch_0/i_gtye4_channel/TXOUTCLK]
